...
export async function paginateRaw<T>(
    ...
    const { page = PAGINATION_DEFAULT_PAGE, limit = PAGINATION_DEFAULT_LIMIT } =
        options;
...
export async function paginateWithIterator<T, IT>(
    queryBuilder: SelectQueryBuilder<T>,
    options: PaginateOptionsDto,
    iterator: (item: T) => IT,
...
export async function paginateWithPromiseIterator<T, IT>(
    queryBuilder: SelectQueryBuilder<T>,
    options: PaginateOptionsDto,
...
export async function paginateRawWithIterator<T, IT>(
    queryBuilder: SelectQueryBuilder<T>,
    options: PaginateOptionsDto,
    iterator: (item: T) => IT,
): Promise<Pagination<IT>> {
